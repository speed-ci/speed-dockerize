...
if [[ "$PUBLISH" == "true" ]]; then
    ...
    echo "curl -u $ARTIFACTORY_USER:$ARTIFACTORY_PASSWORD --silent --noproxy '*' "$ARTIFACTORY_URL/artifactory/docker/$PROJECT_NAMESPACE/$PROJECT_NAME/$TAG/manifest.json" | jq .config.digest | tr -d '"'"
